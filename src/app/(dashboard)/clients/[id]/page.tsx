...
import { ArrowLeft, Mail, Phone, MapPin, ShieldCheck, ShieldX, ShieldAlert, RefreshCw, Upload, Printer, X, ImageIcon, Trash2, ArrowUpDown, Search, Download, Globe, UserPlus, Eye, EyeOff, Palette, Save, Loader2, Link as LinkIcon, Check, Copy, Building2, Users, Briefcase, Smartphone, Ticket, FileText, ChevronDown, Calendar } from "lucide-react";
...
import AteraContractBalance from "@/components/AteraContractBalance";
...
<body>
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Solde contrat Atera */}
      <AteraContractBalance clientId={id} />
