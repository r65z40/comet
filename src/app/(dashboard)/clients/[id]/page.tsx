...
import { ArrowLeft, Mail, Phone, MapPin, ShieldCheck, ShieldX, ShieldAlert, RefreshCw, Upload, Printer, X, ImageIcon, Trash2, ArrowUpDown, Search, Download, Globe, UserPlus, Eye, EyeOff, Palette, Save, Loader2 } from "lucide-react";
...
export default function ClientDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  async function createPortalUser() {
    if (!newPortalUser.name || !newPortalUser.email || !newPortalUser.password) return;
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <button
                  ...
                  disabled={portalUserCreating || !newPortalUser.name || !newPortalUser.email || newPortalUser.password.length < 8}
